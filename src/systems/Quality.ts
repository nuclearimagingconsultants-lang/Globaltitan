...
export const QUALITY: Record<QualityId, QualityState> = {
  auto: {
    id: "auto",
    label: "Auto",
    blurb: "Canonical 300 m load. FrameGuard drops 10% after 30 frames over 18 ms, floor 70%, load 220 m.",
    scale: 0.85,
    bloom: false,
    ssao: false,
    grade: false,
  ...
  low: {
    id: "low",
    label: "Low",
    blurb: "Snappy on RTX 3050 � city still visible (far 360 / load 280). Lean debris.",
    scale: 0.7,
    bloom: false,
    ssao: false,
    grade: false,
  ...
  medium: {
    id: "medium",
    label: "Medium",
    blurb: "RTX 3050 lean. far 400 / load 300 floor-safe. Low debris.",
    scale: 0.75,
    bloom: false,
    ssao: false,
    grade: false,
  ...
  high: {
    id: "high",
    label: "High",
    blurb: "SSAO, rim, bloom. Hero lighting budget. FrameGuard still drops toward 70%.",
    scale: 1,
    bloom: true,
    ssao: true,
    grade: true,
  ...
  cinematic: {
    id: "cinematic",
    label: "Cinematic",
    blurb: "All post + Hulk motion blur. Debris hard-capped at 300. Shadows 120 m.",
    scale: 1,
    bloom: true,
    ssao: true,
    grade: true,
...
/** P0 emergency net. Dynres after 30 frames > 18 ms. −10% steps, floor 70%. */
